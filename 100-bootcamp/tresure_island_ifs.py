#bootcamp day 3 https://www.udemy.com/course/100-days-of-code/learn/lecture/17965132#overview
#tresure_island - project with lots of if's
...
if direction == 'left':
    ...
    if swim_or_wait == 'wait':
        ...
        if door == 'yellow':
            print('Congratulations! You won this extremely difficult game!')
        else:
            print("Wrong choice, I'm sorry but the game is over!")
    else:
        print("Wrong choice, I'm sorry but the game is over!")
